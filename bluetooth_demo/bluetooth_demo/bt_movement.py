...
class SerialBridge(Node):
    ...
    def read_serial(self):
        ...
        try:
            ...
            if data:
                ...
                # I should create a packet structure with known terminators and entry points to make this less easy to break.
                while b'\n' in self.buffer:
    ...
    def process_command(self, command: str):
        ...
        if command == "MOVE_FORWARD":
            twist.linear.x = 0.6    # Adjust speed as necessary.
            twist.angular.z = 0.0
            ...
            twist.linear.x = 0.0
            twist.angular.z = 2.0   # Adjust turn speed as necessary.
            self.get_logger().info("Command: TURN_LEFT. Turning left.")
        elif command == "TURN_RIGHT":
            twist.linear.x = 0.0
            twist.angular.z = -2.0  # Adjust turn speed as necessary.
            self.get_logger().info("Command: TURN_RIGHT. Turning right.")
        elif command == "STOP":
            twist.linear.x = 0.0
            twist.angular.z = 0.0
